...
public class OppUtilityBidDistance extends AbstractBidDistance {
    // same as UtilityBidDistance, but a different class to distinguish the usage
    // of the sampled opponent utility function
    @JsonCreator
    public OppUtilityBidDistance(@JsonProperty("utilitySpace") UtilitySpace utilitySpace) {
        super(utilitySpace);
    }
